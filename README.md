# Preamble: AI-Powered Technical Documentation
Precision engineering for technical documentation in a swiss editorial style.
...
1. Clone the repository: `git clone https://github.com/gontzi/preamble.git`
2. Install dependencies: `npm install` or `yarn install`
3. Start the development server: `npm run dev` or `yarn dev`
4. Open your web browser and navigate to `http://localhost:3000`

## Project Structure Overview
The Preamble project is organized into the following directories:
* `src/app`: Contains the main application code, including actions, components, and pages.
* `src/components`: Houses reusable UI components, such as buttons, badges, and cards.
* `src/lib`: Includes utility functions and libraries, like Supabase and OpenAI integrations.
